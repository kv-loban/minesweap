...
import java.util.*;
public class mine extends JFrame implements ActionListener, ContainerListener  {
    ...
    public void setmanue() {
        ...
        final JCheckBoxMenuItem beginner = new JCheckBoxMenuItem("Начальный");
        final JCheckBoxMenuItem intermediate = new JCheckBoxMenuItem("Средний");
        final JCheckBoxMenuItem expart = new JCheckBoxMenuItem("Эксперт");
        final JCheckBoxMenuItem custom = new JCheckBoxMenuItem("Настроить");
        ...
        helpitem.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                JOptionPane.showMessageDialog(null, "Инструкция");
                        ...
                        if (countmine[i][j] == -1) {
                            for (int k = 0; k < blockr; k++) {
                                for (int l = 0; l < blockc; l++) {
                                    ...
                                    blocks[k][l].removeMouseListener(mh); //проверяются мины рядом с игровыми ячейками
                                }
                            }
                            sw.stop();
                            reset.setIcon(ic[12]);
                            JOptionPane.showMessageDialog(null, "Извини, ты проиграл!"); //выводится сообщение, если попал на мину
    ...
    class Customizetion extends JFrame implements ActionListener {
        ...
        Customizetion() {
            ...
            lb1 = new JLabel("Строк");
            lb2 = new JLabel("Столбцов");
            lb3 = new JLabel("Мин");
             //диалоговое окно для ввода ячеек
        ...
        public void actionPerformed(ActionEvent e) {
            if (e.getSource() == b1) {
                try {
                    ...
                    JOptionPane.showMessageDialog(this, "Неправильно");
                    t1.setText("");
                    t2.setText("");
                    t3.setText("");
                }
